...
public class A05_TypeCasting {
	 ...
	 * # 타입 크기순
	 * 
	 * byte < short , char < int < float(4) <double
	 * 
	...
	public static void main(String[] args) {
		...
		// 작은 타입 값이 큰 타입에 들어갈 때는 별도의 조치 없이 타입이 변한다
		byte b1 = 127;
		...
		// 같은 2byte지만 서로 강제 타입캐스팅이 필요한 관꼐
		short snum = -30000;
		char ch1 = '박';
		
		// char에 short값을 넣을 때는 음수값이 존재할 위험이 잇으므로 강제형변환이 필요하다
		ch1 = (char)snum;
		...
		// ex> 123.123456에서 5를 반올림 하고 싶은 경우
