...
public class E07_File {
	...
	public static void main(String[] args) {
		...
		// isFile(), isDirectory() : 해당 인스턴스가 파일인지 
		// 폴더인지 알아낼 수 있다
		 ...
		 *   
		 */
		File ff1 = new File("C:\\aiautomation_ojj\\work\\myfiles\\text.txt");
		File ff2 = new File(".myfiles\\\\text.txt");
		...
		// mkdirs() : 해당 파일을 만들기 위한 부모 폴더까지 만들어버린다
		if(!ff4.exists()) {
			ff4.mkdirs();
		}
		...
		// listFiles() : 폴더 의 모든 내용을 file[]로 꺼내준다
