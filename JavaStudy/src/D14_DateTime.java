...
public class D14_DateTime {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				dow.getDisplayName(TextStyle.SHORT, Locale.JAPANESE));
		System.out.println(
				dow.getDisplayName(TextStyle.FULL, Locale.JAPANESE));
		...
		System.out.println("달이름: " + 
				thisMonth.getDisplayName(TextStyle.FULL, Locale.FRANCE));
...
//		}
		...
		// TemporalAdjusters 클래스 : TemporalAdjusters를 구현한 인스턴스들을 모아놓은 클래스
		...
		// with 메서드와 함께
		//  TemporalAdjusters의 여러 시간조절기들을 꺼낼 수 있다
