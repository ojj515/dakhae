...
public class D05_WrapperClass {
	...
	public static void main(String[] args) {
		...
		// WrapperClass의 인스턴스를 생성하는 방식(생성자는 지원 만료됨)
		...
		System.out.println("글자인가요?" +Character.isAlphabetic('B'));
		...
		System.out.println("공백인가요?" + Character.isDigit('3'));
		System.out.println("공백인가요?" + Character.isDigit('ㅁ'));
		System.out.println("공백인가요?" + Character.isDigit('#'));
		...
		System.out.println(Character.getType('귤'));
