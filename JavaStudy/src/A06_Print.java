...
public class A06_Print {
	 ...
	 *  1. println()
	 *  
	 *  - ()안에 전달할 데이터를 콘솔에 출력하고 출력 맨 마지막에 \n을 추가한다
	 *  - println()은 데이터를 아무것도 전달하지 않으면 줄만 바꿔준다
	 *  
	 *  2. print()
	 *  
	 *  - ()안에 전달할 데이터를 콘솔에 출력한다
	 *  - 줄을 자동으로 바꿔주지 않는다
	 *  
	 *  3. printf()
	 *  
	 ...
	 *  
	 *  3. %0숫자d : 숫자만큼 자릿수를 확보한 후 빈자리에 0을 출력한다
	 *  
	...
	public static void main(String[] args){
		...
		System.out.printf("%.0f\t%.1f\t%.2f\t%.3f\t%.4f",
				1.565789 , 1.56879 , 1.56879 , 1.56879 , 1.56879);
