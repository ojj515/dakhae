...
public class D01_ArrayList {
	 ...
	 *    ex) 수 많은 데이터 중 특정 데이터를 찾기 위해서는 어떻게 하는게
	 *        가장 효율적일까?
	 * 		  수 많은 데이터들은 순서대로 재배치하는데 가장 효율적인 방법은 무엇일까?
	 *  - 세상에는 이미 수 많은 정답들이 알고리즘 형태로 존재하고 있다
	 *  
	 *  # Java Collections
	 *  
	 *  - 자바 구조들을 구현해놓은 클래스들의 모음을 자바에서는 컬렉션이라고 부른다
	 *  
	 *  # java.util.ArrayList
	 *  
	...
	public static void main(String[] args) {
		...
		System.out.println("0번 과자: " + snaks.get(0));
		...
		// ※ int의 경우 값으로 삭제하고 싶으면 
		// Integer.valueOf()메서드를 사용해야 한다
		...
		// list.subList(start, end) : 리스트의 일부분을 새로운 리스트로 만들어 반환
		//							 (from 이상 to 미만)
