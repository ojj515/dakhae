...
public class D13_Calendar {
	 ...
	 * 
	 * - 달력을 구현해 놓은 클래스
	 * - 날짜 및 시간을 손쉽게 구현할 수 있는 기능들이 구현되어 있다
	 * - 생성사 대신 getInstance()라는 스태틱 메서드로 인스턴스를 받아와 사용한다
	 * 
	 */
	...
	public static void main(String[] args) {
		...
		System.out.println("이번 달의 몇번째 주인가?" +
				now.get(Calendar.WEEK_OF_MONTH));
		System.out.println("올해의 몇번째 날인가?" +
				now.get(Calendar.DAY_OF_YEAR));
		System.out.println("이번 달의 몇번째 날인가?" +
				now.get(Calendar.DAY_OF_MONTH));
		// 요일은 알 수 있지만 번호로 나와서 알기 힘들다
		System.out.println("이번 주의 몇번째 날인가 (요일)?" +
