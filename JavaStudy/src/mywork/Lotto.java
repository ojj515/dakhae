...
public class Lotto {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			if (winCount == 6) {
				System.out.printf("[%2d,%2d,%2d,%2d,%2d,%2d,%2d] vs [%2d,%2d,%2d,%2d,%2d,%2d]", winNums[0], winNums[1],
						winNums[2], winNums[3], winNums[4], winNums[5], winNums[6], userNums[0], userNums[1],
						userNums[2], userNums[3], userNums[4], userNums[5]);
