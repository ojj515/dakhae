...
public class D09_String {
	...
	public static void main(String[] args) {
		...
		// "".startWith(str): 해당 문자열이 전달한 문자열로 시작되는지 확인한다
		String url = "http://naver.com";
		System.out.println(url.startsWith("http://"));
		
		// "".endWith(str): 해당 문자열이 전달한 문자열로 끝나는지 확인한다
		...
		// "".subString(index): 해당 문자열을 index에서 마지막까지 자른 인스턴스를 반환
		...
		// "".toUpperCase(): 해당 문자열을 모두 대문자로 변환한 채 새 인스턴스를 반환
		// "".toLowerCase(): 해당 문자열을 모두 소문자로 변환한 채 새 인스턴스를 반환
		...
		// 위의 텍스트에서 'e'의 위치를 모든 알파벳 e의 위치를 찾아 콘솔에 출력해보세요	
		System.out.println("--------------------------------");
