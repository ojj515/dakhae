...
public class E09_DataStream {
	...
	public static void main(String[] args) {
		...
		try (
			...
			System.out.println("두번째로 썼던 double 값: " + din.readDouble());
			System.out.println("세번째로 썼던 float 값: " + din.readFloat());
			System.out.println("네번째로 썼던 byte 값: " + din.readByte());
			System.out.println("다섯번재로 썼던 short값: " + din.readShort());
