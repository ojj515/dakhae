...
public class C04_Static {
	 ...
	 *  
	 *  - 인스턴스 영역의 반대 개념
	 *  - 같은 클래스로 만들어진 모든 인스턴스들이 함께 사용하는 공통 영역
	 ...
	 *  - 스태틱 영역의 값은 인스턴스 영역에 활용할 수 있지만
	 	...
	 	- 메서드(인스턴스가 존재하지 않을 때도 동작할 수 있는 메서드)
	 	- 클래스 내부의 클래스 (?)
...
class TrumphCard {
	...
	static void printCardInfo() {
		...
		System.out.println("이 카드의 너비: + " + card_height);
		// System.out.println("이 카드의 너비: + " + rank);
	}
