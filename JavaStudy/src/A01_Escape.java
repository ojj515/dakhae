...
public class A01_Escape {
	 ...
	 *   - \와 하나와 문자를 합쳐 두 문자가 되었지만 하나의 문자로 인식한다
	 */
	...
	public static void main(String[] args) {
		...
		System.out.println("김철수\t010-1234-1234\t26\t대리");
		System.out.println("김철수\t010-1234-1234\t27\t과장");
		...
		// 자바에서는 문자 타입으로 작은따옴표를 사용하고 싶을 때만 사용한다
		System.out.println('\'');
