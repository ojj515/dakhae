...
public class B14_Array2 {
	...
	public static void main(String[] args) {
		...
		char[][][] messages = {negativeMessage,positveMessage};
		...
		System.out.println("---------------");
		for(int i = 0; i < negativeMessage.length; ++i) {
			for(int j = 0; j < negativeMessage[i].length; ++j) {
				System.out.printf("[%d][%d]: %c\n",
						i, j, negativeMessage[i][j]);
			}
			System.out.println("----------------");
		}
